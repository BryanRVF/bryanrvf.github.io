...
.map-container {
  ...
  margin-right: 20px; /* Ajusta la separación entre el mapa y el texto */
}

.contact-info {
  flex: 1;
  max-width: 100%; /* Asegura que el contenedor ocupe el 100% del ancho disponible */
}
...
.contact-item {
  ...
  align-items: center;
  position: relative;
  flex-basis: 300px; /* Establece el ancho base de los cuadros */
  max-width: 100%; /* Asegura que el ancho máximo sea 100% del contenedor padre */
}

.contact-item.large-item {
  flex-basis: 400px; /* Ajusta el ancho base para agrandar este cuadro específico */
  max-width: 100%; /* Asegura que el ancho máximo sea 100% del contenedor padre */
}
...
@media (min-width: 768px) {
  .contact-section {
    flex-wrap: nowrap;
    gap: 20px; /* Ajusta la separación para pantallas más grandes */
  }
