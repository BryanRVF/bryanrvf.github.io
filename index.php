...
#section2 {
    color: white;
    background-image: url('imagenes/closet1.jpg'); /* Reemplaza con la URL de tu imagen */
}
...
@media (max-width: 480px) {
    ...
    <section class="features-section">
        ...
        <div class="feature-box">
            ...
            <h3>GARANTÍA</h3>
            <p>Todos nuestros productos cuentan con garantía de fabricación y una adicional
                 de tienda, para la tranquilidad y comodidad de los clientes.</p>
        </div>
    </section>
    </div>
    ...
    <div class="block" id="section2">
        ...
        <h2>No dudes en buscarnos</h2>
        <p>Somos los especialistas que necesitas para hacer tu proyecto una realidad.</p>
        <button onclick="()"><h5> Contáctanos </h5></button>
    </div>
